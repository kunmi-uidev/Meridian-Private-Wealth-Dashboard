  ...
  return (
    ...
    >
      <div
        ...
        className={`w-full max-w-[680px] rounded-[24px] sm:rounded-[28px] p-6 sm:p-9 shadow-2xl transition-all border ${
          isDark
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4 mt-6 sm:mt-8">
          ...
          <button
            ...
            className={`p-5 sm:p-6 rounded-2xl text-left transition-all duration-150 cursor-pointer relative flex flex-col justify-between min-h-[110px] sm:min-h-[120px] ${
              selected === 'simple'
                ? isDark
                  ? 'border-[1.5px] border-blue-500 bg-slate-900 shadow-xs'
                  : 'border-[1.5px] border-[#185ABC] bg-white shadow-xs'
                : isDark
        ...
        <button
          ...
          disabled={!selected}
          className={`w-full mt-6 sm:mt-8 py-3 sm:py-3.5 rounded-xl text-xs sm:text-sm font-medium transition-all duration-150 flex items-center justify-center ${
            selected
              ? isDark
                ? 'bg-blue-600 hover:bg-blue-500 text-white cursor-pointer shadow-xs'
                : 'bg-[#06397A] hover:bg-[#052E63] text-white cursor-pointer shadow-xs'
              : isDark
